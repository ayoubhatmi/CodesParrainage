...
export const topOffers = [
...

  {
    ...
    category: "Cryptomonnaie",
    description:
      "Showroomprive.com est un site de vente événementielle en ligne. Le site propose chaque jour à ses membres en France et dans six autres pays européens des ventes événementielles exclusives avec des réductions. Le groupe est devenu un des leaders européens du commerce en ligne et compte aujourd'hui plus de 25 millions de membres, ainsi que 3 000 marques partenaires",
